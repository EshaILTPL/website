...
export default function FaqChatSection() {
    ...
    return (
        <section className="w-full bg-[#f5f5f5e8] py-12">
                ...
                <div className="border-black/20 border-b-[1.5px] border-dashed mb-4">
                    <div className="w-1/2 max-w-sm mx-auto mb-4">
                        ...
                        <div className="max-w-4xl mx-auto px-8 text-center mb-4">
                            <h2 className="text-black text-xs px-8 normal-text mt-2">
            ...
            {/* FAQ Chat Bubbles */}
            <div className="max-w-xl mx-auto text-center flex flex-col py-2 gap-4 px-10 border-black/20 border-r-[1.5px] border-b-[1.5px] border-l-[1.5px] border-dashed">
                {faqs.map((faq) => (
                    <div key={faq.id} className="w-full">
                        ...
                        <div className="flex justify-end items-center gap-2">
                            ...
                            {/* Question Text */}
                            <div className="bg-white border border-dashed border-black/20 px-4 py-2 rounded-full flex items-center justify-center max-w-[70%] text-black text-xs">
                                <span>{faq.q}</span>
                            </div>
                        </div>
                        ...
                        <AnimatePresence>
                            {openId === faq.id && (
                                ...
                                >
                                    <div className="max-w-[70%] bg-white border border-dashed border-black/20 rounded-tr-xl rounded-tl-xl rounded-br-xl p-3 shadow-sm text-black text-xs leading-relaxed">
                                        <p>{faq.a}</p>
                                    </div>
            ...
            <div className="flex items-center justify-between mb-4">
                {/* Left text */}
                <p className="text-black text-xs normal-text pt-4 mb-0">
                ...
                <div className="mt-8">
                    ...
                    >
                        <a
                            href="#pricing"
                            className="relative inline-flex items-center normal-text justify-center bg-black text-white text-xs font-small px-4 py-4 rounded-full min-w-[50px] transition-all duration-500 overflow-hidden group"
                        >
                            {/* Default text */}
